...
public class NonBlockingConnectionHandler<T> implements ConnectionHandler<Message> {

    private static final int BUFFER_ALLOCATION_SIZE = 1 << 13; //8k
    private static final ConcurrentLinkedQueue<ByteBuffer> BUFFER_POOL = new ConcurrentLinkedQueue<>();

    private final BGSMessagingProtocol<T> protocol;
    private final BGSMessageEncoderDecoder<T> encdec;
    ...
    public NonBlockingConnectionHandler(
            ...
            BGSMessagingProtocol<T> protocol,
            SocketChannel chan,
            Reactor reactor,
            int connectionID,
